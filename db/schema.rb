...
ActiveRecord::Schema.define(version: 2024_01_05_120404) do
  ...
  create_table "user_ocrs", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "text"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_user_ocrs_on_user_id"
  end
  ...
  add_foreign_key "user_ocrs", "users"
end
